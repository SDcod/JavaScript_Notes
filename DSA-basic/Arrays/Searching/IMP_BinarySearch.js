...
//take three pointers low=start,mid = len/2 and high=end
//Run a loop until low <=hight;initialize mid inside loop ; if(arr[mid]==x) return mid ; if (arr[mid]>x) set high=mid-1 ; else low = mid+1
